...
TEST_CASE("First Order Logic With Pre and Post Processor")
{
    ...
    preProcessor.addTokenRecord("~", 0, BasicProcessorTokenRecord::Associativity::Left, 0);
    preProcessor.addTokenRecord("&", 1, BasicProcessorTokenRecord::Associativity::Left, 1);
    preProcessor.addTokenRecord("|", 1, BasicProcessorTokenRecord::Associativity::Left, 2);
    preProcessor.addTokenRecord("->", 1, BasicProcessorTokenRecord::Associativity::Right, 3);
    preProcessor.addTokenRecord("<->", 1, BasicProcessorTokenRecord::Associativity::Left, 4);
    preProcessor.addTokenRecord("U", 0, BasicProcessorTokenRecord::Associativity::Right, 5);
    preProcessor.addTokenRecord("E", 0, BasicProcessorTokenRecord::Associativity::Right, 6);

    preProcessor.addTokenRecord("P", 0, BasicProcessorTokenRecord::Associativity::Right, 0);
    preProcessor.addTokenRecord("Q", 0, BasicProcessorTokenRecord::Associativity::Right, 0);
    preProcessor.addTokenRecord("R", 0, BasicProcessorTokenRecord::Associativity::Right, 0);

    //Post Processor
    BasicPostProcessor postProcessor(&signature);

    postProcessor.addTokenRecord("~", 0, BasicProcessorTokenRecord::Associativity::Left, 0);
    postProcessor.addTokenRecord("&", 1, BasicProcessorTokenRecord::Associativity::Left, 1);
    postProcessor.addTokenRecord("|", 1, BasicProcessorTokenRecord::Associativity::Left, 2);
    postProcessor.addTokenRecord("->", 1, BasicProcessorTokenRecord::Associativity::Right, 3);
    postProcessor.addTokenRecord("<->", 1, BasicProcessorTokenRecord::Associativity::Left, 4);
    postProcessor.addTokenRecord("U", 0, BasicProcessorTokenRecord::Associativity::Right, 5);
    postProcessor.addTokenRecord("E", 0, BasicProcessorTokenRecord::Associativity::Right, 6);

    postProcessor.addTokenRecord("P", 0, BasicProcessorTokenRecord::Associativity::Right, 0);
    postProcessor.addTokenRecord("Q", 0, BasicProcessorTokenRecord::Associativity::Right, 0);
    postProcessor.addTokenRecord("R", 0, BasicProcessorTokenRecord::Associativity::Right, 0);
